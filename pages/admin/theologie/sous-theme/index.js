...
function SousThème({ router }) {
    ...
    const showSousThemes = () => {
        return sousThemes.map((st, i) => {
            return <button onDoubleClick={() => deleteConfirm(st.slug)} title='Faites un double clique pour supprimer le thème' key={i} className="btn btn-light m-2" data-mdb-ripple-color="dark">
                {st.name}
            </button>
        })
    }
          ...
          <div className='container categorie_page'>
            ...
            <div className="row">
                <div className='col-lg-8 col-md-8 col-sm-12'>
                    ...
                    <div>
                        <p>Merci de cliquer sur le thème associé</p>
                        {showThemes()}
                    </div>
